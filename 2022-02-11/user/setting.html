        ...
        <div class="d-flex">
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                      <div class="col-2">
                        <img src="img/nopic-male.jpg" width="150px" class="rounded-circle center mx-auto">
                      </div>  
                      ...
                      <label for="basic-url" class="form-label">Bio</label>
                        <textarea class="form-control" placeholder="your bio" id="bio" >Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati, debitis atque aspernatur est, aperiam expedita repudiandae tempore nulla cumque</textarea>
                      </div>
                      </div>
