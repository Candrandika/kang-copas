                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <div class="page-title">
                                        <h4 class="mb-0 font-size-18">Data Tautan</h4>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">LinkU</a></li>
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Tables</a></li>
                                            <li class="breadcrumb-item active">Data Tautan</li>
                                        </ol>
                                    </div>
                                            ...
                                            <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>facebook.com, intagram.com, twitter.com</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>twitter.com, whatsapp.com</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>whatsapp.com, youtube.com</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>facebook.com, twitter.com</td>
                                                        
                                                        
                                                    </tr>
                                                    <tr>
                                                        <td>10</td>
                                                        <td>sonyaisfreezing</td>
                                                        <td>Behance, Discord</td>
                                                        <td>behance.com, discord.com</td>
