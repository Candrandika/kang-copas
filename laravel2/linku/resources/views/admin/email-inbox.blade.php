                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="email-read.html">Pesan Di Baca</a></li>
                                </ul>
                            </li>
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <div class="page-title">
                                        <h4 class="mb-0 font-size-18">Pesan Masuk</h4>
                                        <ol class="breadcrumb">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="email-leftbar card">
                                        <a href="email-compose.html" class="btn btn-info waves-effect waves-light">Compose</a>
                                        ...
                                        <div class="card">
                                            ...
                                            <ul class="message-list">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="col-mail col-mail-2">
                                                        <a href="#" class="subject">Hey man – <span class="teaser">Nah man sorry
                                                ...
                                                <li class="unread">
                                                    ...
                                                    <div class="col-mail col-mail-2">
                                                        <a href="#" class="subject"><span
                                                                class="bg-info badge me-2">Support</span>Home again! – <span
                                                ...
                                                <li>
                                                    ...
                                                    <div class="col-mail col-mail-2">
                                                        <a href="#" class="subject">Train/Bus – <span class="teaser">Yes ok,
